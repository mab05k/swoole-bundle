...
final class ServerConfig
{
    ...
    public function add(array $config): void
    {
        ...
        if (!empty($errorBag)) {
            throw new \RuntimeException(\sprintf('Configuration errors have occurred: %s', \implode(', ', \array_map(function (\Throwable $err): string { return $err->getMessage(); }, $errorBag))));
        }
    }
